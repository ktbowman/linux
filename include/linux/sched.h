...
struct sched_avg {
	...
	u64				load_sum;
	u64              RH_KABI_RENAME(runnable_load_sum, runnable_sum);
	u32				util_sum;
	u32				period_contrib;
	unsigned long			load_avg;
	unsigned long    RH_KABI_RENAME(runnable_load_avg, runnable_avg);
...
#endif
	RH_KABI_REPLACE(volatile long	state,
...
# define MAX_LOCK_DEPTH			48UL
...
#endif
	RH_KABI_FILL_HOLE(struct kmap_ctrl kmap_ctrl)
#ifdef CONFIG_DEBUG_ATOMIC_SLEEP
	...
	RH_KABI_REPLACE(atomic_t stack_refcount, refcount_t stack_refcount)
#endif
