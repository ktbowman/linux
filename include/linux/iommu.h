...
enum iommu_attr {
	...
	RH_KABI_BROKEN_REMOVE_ENUM(DOMAIN_ATTR_WINDOWS)
	RH_KABI_BROKEN_REMOVE_ENUM(DOMAIN_ATTR_FSL_PAMU_STASH)
	RH_KABI_BROKEN_REMOVE_ENUM(DOMAIN_ATTR_FSL_PAMU_ENABLE)
	RH_KABI_BROKEN_REMOVE_ENUM(DOMAIN_ATTR_FSL_PAMUV1)
