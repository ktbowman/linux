...
#include RH_KABI_HIDE_INCLUDE(<linux/mmu_notifier.h>)
...
#if MAX_NUMNODES > 1
RH_KABI_ADD_MODIFIER(unsigned) int nr_node_ids __read_mostly = MAX_NUMNODES;
...
{
	struct capture_control *capc = current->task_struct_rh->capture_control;
